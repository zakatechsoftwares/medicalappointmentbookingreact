        ...
        <Page size="A4" style={styles.page}>
          <View style={styles.section}>
            <Text>
              <Text>
                ...
                Doctor's name: {state.doctorName} {"\n"}
          ...
          <View style={styles.section}>
            <Text>
              ...
              alias error harum maxime adipisci amet laborum. Perspiciatis
              minima nesciunt dolorem! Officiis iure rerum voluptates a cumque
              velit quibusdam sed amet tempora. Sit laborum ab, eius fugit
              ...
              numquam totam ratione voluptas quod exercitationem fuga. Possimus
              quis earum veniam quasi aliquam eligendi, placeat qui corporis!
            </Text>
          </View>
        </Page>
      </Document>
